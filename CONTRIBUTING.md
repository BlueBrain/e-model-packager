...
We would love for you to contribute to the e-model-packager project and help make it better than it is today.
...
We just require that the style conform to pycodestyle, pydocstyle, pylint and black standards.
To test if your changes conform to these standards, run the following command: `tox -e lint`
